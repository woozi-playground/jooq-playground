...
class FilmRepositoryDaoTest {
    ...
    void 상속_DAO_1() {
        ...
        // when
        List<Film> films = filmRepositoryIsA.fetchRangeOfLengthEntity(start, end);
    ...
    void 컴포지션_DAO_1() {
        ...
        // when
        List<Film> films = filmRepositoryHasA.fetchRangeOfLengthEntity(start, end);
